...
/* 🌟 手札メインカード（スマホのChromeの横幅に合わせてさらにゆったり拡大！） */
.hand-card {
  display: flex;
  flex-direction: column;
  gap: 0rem;            
  ...
  /* 🌟 幅の修正ポイント：スマホ画面の両端ギリギリまで広げるため、94% ➔ 98% に拡大！ */
  width: 97%;           /* 💡 ほぼ画面横幅いっぱいまでダイナミックに広げます */
  max-width: 420px;     /* 💡 カードを広げた分、PCでの最大幅の上限も 380px ➔ 420px に拡張してバランスを維持 */
